    ...
    <div className="p-8">
      <div className="mb-8 flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-ink-500">Ask anything about your projects, tasks, and invoices.</p>
        </div>
        <div className="flex items-center gap-2">
          <Button
            variant={view === 'chat' ? 'primary' : 'secondary'}
            size="sm"
            onClick={() => navigate('/portal/brain')}
          >
          ...
          <Button
            ...
            size="sm"
            onClick={() => navigate('/portal/brain/graph')}
          >
      ...
      {view === 'chat' ? <BrainChat portal /> : <BrainGraph portal />}
    </div>
  );
}
